...
class TritonDeployment:
    def __init__(self):
        ...
        self._triton_server = tritonserver.Server(
            model_repository=["/workspace/resnet50-models"],
            model_control_mode=tritonserver.ModelControlMode.EXPLICIT
        )
        self._triton_server.start(wait_until_ready=True)
        self._triton_server.load("resnet50")
        self._resnet50 = self._triton_server.models()["resnet50"]
    ...
    def classify(self, image_name: str) -> str:
        model = self._resnet50 # self._triton_server.models()["resnet50"]
