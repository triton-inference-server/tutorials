...
def client(request_count, endpoint, index):
    ...
    prompts = ["who is garfield?", "what is ai?", "who are you?","what did you have for lunch?","what is rock and roll?"]
#    endpoint = "imagine"
#    endpoint = "generate"
    #endpoint = "classify"
...
if __name__ == "__main__":
    ...
    time.sleep(5)
    proc.kill()
    print(f"overall time: {(args.requests*args.concurrent)/(end_time-start_time)}")
