...
from openapi_server.models.create_chat_completion_function_response_choices_inner import (
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "choices": [
                    CreateChatCompletionFunctionResponseChoicesInner.from_dict(_item)
